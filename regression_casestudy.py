...
# =============================================================================
# Setting working directory and dimensions for plot 
# =============================================================================
import os

# Specify the path to the directory you want to change to
new_directory = "C:\\Users\\HP\\OneDrive\\Desktop\\regression_proj"
...
cars_omit=cars_omit.drop(columns=col2, axis=1)
...
# Transformin price as a logarithmic value
y2 = np.log(y2)
...
This is to set a benchmark and to compare with our regression model
"""
# fingind the mean for test data value
base_pred=np.mean(y_test1)
print(base_pred)
...
# Model parameters
rf2 = RandomForestRegressor(n_estimators=100,ma)
##############################################################################
